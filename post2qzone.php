...
<hr>
<p>最近工作比较忙, 没时间优化后台配置界面, 请各位多多包涵, 如有不清楚的地方或建议, 请:<br /> 
<a href="http://liguoliang.com/2010/post2qzone/" target='_blank'>访问插件主页查找更多信息</a>或直接联系: guoliang.me@gmail.com, <br>
如果大家觉得插件用着还好, 请推荐给身边的其他博友, 谢谢!
</p>

<strong>1.1.0 更新说明: 如发现同步出现问题, 请确定参与目录填写是否正确.</strong>
<ul>
<li>	1. 增加了同步长度 - 如果需要输出全文, 请将长度设置为0.</li>
<li>	2. 增加了参与同步的目录, 请填入参与同步的目录ID, 多个ID请以半角逗号分隔. 如果要全站文章参与同步, 请留空.</li>
</ul>
</div>
